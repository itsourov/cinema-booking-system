<x-admin-layout>
    <div class="my-10 px-2 md:px-5 ">
        <x-card class="max-w-3xl mx-auto py-8 px-4">
            ...
            <form action="{{ route('admin.movies.create') }}" method="post" class="space-y-6">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <x-text-input placeholder="Synopsis here" name="synopsis" type="text" :value="old('synopsis')" />
                ...
                <div>
                    ...
                    <x-text-input placeholder="release_date" name="release_date" :value="old('release_date')" type="date" />
